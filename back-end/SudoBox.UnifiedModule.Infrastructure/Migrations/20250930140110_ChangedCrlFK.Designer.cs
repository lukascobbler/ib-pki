...
namespace SudoBox.UnifiedModule.Infrastructure.Migrations
{
    ...
    [Migration("20250930140110_ChangedCrlFK")]
    partial class ChangedCrlFK
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SudoBox.UnifiedModule.Domain.CRL.RevokedCertificate", b =>
                {
                    ...
                    b.HasKey("CertificateSerialNumber")
            ...
            modelBuilder.Entity("SudoBox.UnifiedModule.Domain.Certificates.KeyManagement.MasterKey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_master_keys");

                    b.ToTable("master_keys", "unified");
                });

            modelBuilder.Entity("SudoBox.UnifiedModule.Domain.Certificates.KeyManagement.UserKey", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid")
                        .HasColumnName("user_id");
            ...
            modelBuilder.Entity("SudoBox.UnifiedModule.Domain.CRL.RevokedCertificate", b =>
                {
                    b.HasOne("SudoBox.UnifiedModule.Domain.Certificates.Certificate", "Certificate")
                        .WithOne()
                        .HasForeignKey("SudoBox.UnifiedModule.Domain.CRL.RevokedCertificate", "CertificateSerialNumber")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_revoked_certificates_certificates_certificate_serial_number");
            ...
            modelBuilder.Entity("SudoBox.UnifiedModule.Domain.Certificates.KeyManagement.UserKey", b =>
                {
                    b.HasOne("SudoBox.UnifiedModule.Domain.Users.User", null)
                        .WithOne()
                        .HasForeignKey("SudoBox.UnifiedModule.Domain.Certificates.KeyManagement.UserKey", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
